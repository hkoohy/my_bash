...
# filter out less condfident, more than 300 to remove high signal regions which are homologue to MT

radias=250
distance_cutoff=100 #peaks shroter than this will be merged

outdir=/bi/group/sysgen/Hashem/ISP_from_Dan/MACS_Outputs/FrBC_ATAC_Dan/ATAC_FrBC_Aged_and_Young_Concatenated_V2/
Y_npeaks_fname=/bi/group/sysgen/Hashem/ISP_from_Dan/MACS_Outputs/FrBC_ATAC_Dan/FrBC_Y_2Reps_Merged/ATAC_FrBC_Y_2Reps_Merged_peaks.narrowPeak
...
A_npkeas_fname=/bi/group/sysgen/Hashem/ISP_from_Dan/MACS_Outputs/FrBC_ATAC_Dan/FrBC_A_2Reps_Merged/ATAC_FrBC_A_2Reps_Merged_peaks.narrowPeak
