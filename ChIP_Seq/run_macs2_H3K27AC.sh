...
# macs2 callpeak -t ${bams_dir}lane5362_ACTTGA_K27ac_young1_L003_R1_val_1_GRCm38_bowtie2.bam \
# --outdir ${output_dir}FrD_H3K27AC_YR1 \
# -c ${Young_Input_File} \
# -g mm --broad -n FrD_H3K27AC_YR1 -f BAM -q 0.01 --broad-cutoff 0.05 --nomodel --extsize 146


# macs2 callpeak -t ${bams_dir}lane5362_GTGGCC_K27ac_young2_L003_R1_val_1_GRCm38_bowtie2.bam \
# --outdir ${output_dir}FrD_H3K27AC_YR2 \
# -c ${Young_Input_File} \
# -g mm --broad -n FrD_H3K27AC_YR2 -f BAM -q 0.01 --broad-cutoff 0.05 --nomodel --extsize 146
...
# macs2 callpeak -t ${bams_dir}lane5362_TAGCTT_K27ac_old2_L003_R1_val_1_GRCm38_bowtie2.bam \
# --outdir ${output_dir}FrD_H3K27AC_AR2 \
# -c ${Aged_Input_File} \
# -g mm --broad -n FrD_H3K27AC_AR2 -f BAM -q 0.01 --broad-cutoff 0.05 --nomodel --extsize 146
